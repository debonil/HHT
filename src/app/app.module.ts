...
import { ShowChartPage } from '../pages/chart/showChart/showChart';
...
import { ChartTabsPageModule } from '../pages/chart-tabs/chart-tabs.module';
...
@NgModule({
  declarations: [
     ...
     ShowChartPage,
     ChartPsngPage,
     ComponentsTristateToggleComponent,
